...
import com.secuso.privacyfriendlysudoku.controller.NewLevelManager;
        ...
        InterstitialAd.load(
                ...
                new InterstitialAdLoadCallback() {
                    ...
                    public void onAdLoaded(@NonNull InterstitialAd interstitialAd) {
                        ...
                        // an ad is loaded.
                        DailySudokuActivity.this.mInterstitialAd = interstitialAd;
                        Log.i("TAG", "onAdLoaded");
                        Toast.makeText(DailySudokuActivity.this, "onAdLoaded()", Toast.LENGTH_SHORT).show();
                        interstitialAd.setFullScreenContentCallback(
                                new FullScreenContentCallback() {
                                    ...
                                    public void onAdDismissedFullScreenContent() {
                                        ...
                                        DailySudokuActivity.this.mInterstitialAd = null;
                    ...
                    public void onAdFailedToLoad(@NonNull LoadAdError loadAdError) {
                        ...
                        Toast.makeText(
                                DailySudokuActivity.this, "onAdFailedToLoad() with error: " + error, Toast.LENGTH_SHORT)
                                .show();
                    }
                });
    }
